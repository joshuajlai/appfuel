...
/**
 * Holds generic blocks of string in an array to be constructed later into
 * a single string
 */
interface ContentInterface
{
	...
	/**
	 * Add a content block to the content list. Each block will 
