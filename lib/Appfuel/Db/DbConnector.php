...
class DbConnector implements DbConnectorInterface
{
	...
	/**
	 * @param	DbConnectionInterface	$master
	 * @param	DbConnectionInterface	$slave	optional 
	 * @return	DbConnector
	 */
	public function __construct(DbConnectionInterface $master,
								DbConnectionInterface $slave = null)
	{
		$this->master = $master;
	...
	{
		return $this->master instanceof DbConnectionInterface;
	}
	...
	{
		return $this->slave instanceof DbConnectionInterface;
	}
	...
	{
		throw new RunTimeException("Clone is not allowed for Connectors");
	}
