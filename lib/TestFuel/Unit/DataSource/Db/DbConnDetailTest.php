...
use StdClass,
	...
	Appfuel\DataSource\Db\DbConnDetail;
 ...
 */
class DbConnDetailTest extends BaseTestCase
{
	/**
	...
	public function testValid()
	{
		...
		$detail = new DbConnDetail($params);
		...
		$this->assertEquals($params['options'], $detail->getOptions());

		$this->assertEquals(3307, $detail->getOption('port'));
		$this->assertEquals('mysql.sock', $detail->getOption('socket'));
	}
