 ...
 * 
 */
class PreparedStmtTest extends ParentTestCase
{
	/**
	 * System under test
	 * @var Server
	 ...
	 * @return	null
	 */
	public function testGetIsHandle()
	{
		$result = $this->stmt->getHandle();
		$this->assertInstanceOf('mysqli_stmt', $result);
		$this->assertSame($this->serverHandle, $result);
		$this->assertTrue($this->stmt->isHandle());
	}
	...
	public function testCloseBeforePrepare()
	{
		...
		$this->assertFalse($this->stmt->isHandle());
		$this->assertNull($this->stmt->getHandle());
	}
